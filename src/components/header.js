...
const Header = () => {
    ...
    return (
        <div className='header d-flex align-items-center justify-content-space-between'>
            <div className='header-left d-flex align-items-center mxy-30'>
                ...
                <div className='menubar' >
                    ...
                    <svg
                        ...
                        viewBox="0 0 24 24"
                        focusable="false"
                        class='menu style-scope yt-icon pointer'
                        style={{ width: "38px", height: "50px" }}>

                        <g class="style-scope yt-icon">
                            <path d="M21 6H3V5h18v1zm0 5H3v1h18v-1zm0 6H3v1h18v-1z" class="style-scope yt-icon"></path>
                        </g>
            ...
            <div className='search-middle d-flex align-items-center'>
                <div className='input-box border relative' >
                    ...
                    <div className='search-box absolute d-flex align-items-center justify-content-center' >
                        ...
                        >
                            ...
                            <g class="style-scope yt-icon">
                                <path d="m20.87 20.17-5.59-5.59C16.35 13.35 17 11.75 17 10c0-3.87-3.13-7-7-7s-7 3.13-7 7 3.13 7 7 7c1.75 0 3.35-.65 4.58-1.71l5.59 5.59.7-.71zM10 16c-3.31 0-6-2.69-6-6s2.69-6 6-6 6 2.69 6 6-2.69 6-6 6z" class="style-scope yt-icon"></path>
                            </g>
                        </svg>
                    </div>
                </div>
                ...
                <div className='voice-search d-flex align-items-center'>
                    ...
                    >
                        ...
                        <g class="style-scope yt-icon">
                            <path d="M12 3c-1.66 0-3 1.37-3 3.07v5.86c0 1.7 1.34 3.07 3 3.07s3-1.37 3-3.07V6.07C15 4.37 13.66 3 12 3zm6.5 9h-1c0 3.03-2.47 5.5-5.5 5.5S6.5 15.03 6.5 12h-1c0 3.24 2.39 5.93 5.5 6.41V21h2v-2.59c3.11-.48 5.5-3.17 5.5-6.41z" class="style-scope yt-icon"></path>
                        </g>
                    </svg>
                </div>
            </div>
                ...
                <div className="profile-menu">
                    <div className="profile-img">
                        <img
                            ...
                            src="https://yt3.ggpht.com/yti/AHyvSCAbxi7vIfSv5u0sNQLXVigq83EofkL6vhL9wA=s88-c-k-c0x00ffffff-no-rj-mo"
                            alt=""
                            className="img-dp"
                        />
                    </div>
